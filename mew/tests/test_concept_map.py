...
import pytest
from mew import ConceptMapWidget
...
class TestConceptMapWidget:
    ...
    def test_initialization(self):
        w = ConceptMapWidget(question="Map these:", concepts=CONCEPTS, terms=TERMS, correct_edges=CORRECT_EDGES)
    ...
    def test_correct_edges_structure(self):
        w = ConceptMapWidget(question="Map:", concepts=CONCEPTS, terms=TERMS, correct_edges=CORRECT_EDGES)
    ...
    def test_value_update_all_correct(self):
        w = ConceptMapWidget(question="Map:", concepts=CONCEPTS, terms=TERMS, correct_edges=CORRECT_EDGES)
        w.value = {
            "edges": [{"from": e["from"], "to": e["to"], "label": e["label"], "correct": True} for e in CORRECT_EDGES],
            "score": 3,
            "total": 3,
            "correct": True,
        }
