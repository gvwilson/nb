...
import pytest
from mew import FlashcardWidget

CARDS = [
    {"front": "What is a closure?", "back": "A function that captures its enclosing scope."},
    {"front": "Define memoization.", "back": "Caching results of expensive function calls."},
...
class TestFlashcardWidget:
    ...
    def test_value_update_in_progress(self):
        w = FlashcardWidget(cards=CARDS)
        w.value = {"results": {0: {"rating": "got_it", "attempts": 1}}, "complete": False}
    ...
    def test_multiple_attempts(self):
        w = FlashcardWidget(cards=CARDS)
        w.value = {"results": {0: {"rating": "got_it", "attempts": 3}}, "complete": False}
